...
type
  ...
  TDBGridSearchPanelTextEditEh = class(TDBComboBoxEh)
  private
  ...
  public
    ...
    property Grid: TCustomDBAxisGridEh read FGrid write FGrid;
...
{ TDBGridSearchPanelControlEh }
  ...
  private
    ButtonWidth: Integer;
    FFindEditor: TDBGridSearchPanelTextEditEh;
    FGrid: TCustomDBAxisGridEh;
  ...
  public
    constructor Create(AGrid: TCustomDBAxisGridEh); reintroduce;
    destructor Destroy; override;
    ...
    property FindEditor: TDBGridSearchPanelTextEditEh read FFindEditor;
...
constructor TDBGridSearchPanelTextEditEh.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
...
destructor TDBGridSearchPanelTextEditEh.Destroy;
begin
  inherited Destroy;
end;

procedure TDBGridSearchPanelTextEditEh.Change;
var
  AGrid: TCustomDBGridEhCrack;
begin
  inherited Change;
  AGrid := TCustomDBGridEhCrack(Grid);
  if Assigned(AGrid.SearchPanel.OnSearchEditChange) then
    AGrid.SearchPanel.OnSearchEditChange(AGrid, Self);
...
procedure TDBGridSearchPanelTextEditEh.CMMouseEnter(var Message: TMessage);
begin
  Color := StyleServices.GetSystemColor(clWindow);
  inherited;
end;

procedure TDBGridSearchPanelTextEditEh.CMMouseLeave(var Message: TMessage);
begin
  if not Focused then
...
procedure TDBGridSearchPanelTextEditEh.CreateParams(var Params: TCreateParams);
begin
...
procedure TDBGridSearchPanelTextEditEh.CreateWnd;
begin
  inherited CreateWnd;
...
procedure TDBGridSearchPanelTextEditEh.DoEnter;
begin
  Color := StyleServices.GetSystemColor(clWindow);
...
procedure TDBGridSearchPanelTextEditEh.DoExit;
begin
...
procedure TDBGridSearchPanelTextEditEh.DrawNonClientBorder;
var
  DC, OldDC: HDC;
  R, R1: TRect;
begin
...
procedure TDBGridSearchPanelTextEditEh.SetIsEmptyState(const Value: Boolean);
begin
  FIsEmptyState := Value;
...
procedure TDBGridSearchPanelTextEditEh.WMNCPaint(var Message: TWMNCPaint);
begin
  DrawNonClientBorder;
end;

procedure TDBGridSearchPanelTextEditEh.WMSetFocus(var Message: TWMSetFocus);
begin
...
procedure TDBGridSearchPanelTextEditEh.WMKillFocus(var Message: TWMKillFocus);
begin
  inherited;
  if Grid is TCustomDBGridEh then
    TCustomDBGridEhCrack(Grid).Invalidate;
...
procedure TDBGridSearchPanelTextEditEh.WMLButtonDown(var Message: TWMLButtonDown);
begin
...
procedure TDBGridSearchPanelTextEditEh.MouseDown(Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  inherited MouseDown(Button, Shift, X, Y);
end;

procedure TDBGridSearchPanelTextEditEh.KeyPress(var Key: Char);
var
  Grid: TCustomDBGridEhCrack;
begin
  Grid := TCustomDBGridEhCrack(Self.Grid);
  if Assigned(Grid.SearchPanel.OnSearchEditKeyPress) then
    Grid.SearchPanel.OnSearchEditKeyPress(Grid, Self, Key);
...
procedure TDBGridSearchPanelTextEditEh.KeyDown(var Key: Word; Shift: TShiftState);
var
...
begin
  ...
  if Assigned(Grid.SearchPanel.OnSearchEditKeyDown) then
    Grid.SearchPanel.OnSearchEditKeyDown(Grid, Self, Key, Shift);
...
procedure TDBGridSearchPanelTextEditEh.KeyUp(var Key: Word; Shift: TShiftState);
var
  Grid: TCustomDBGridEhCrack;
begin
  Grid := TCustomDBGridEhCrack(Self.Grid);
  if Assigned(Grid.SearchPanel.OnSearchEditKeyUp) then
    Grid.SearchPanel.OnSearchEditKeyUp(Grid, Self, Key, Shift);

  inherited KeyUp(Key, Shift);
end;

procedure TDBGridSearchPanelTextEditEh.SpecInternalSetText(const AText: String);
begin
...
procedure TDBGridSearchPanelTextEditEh.CalcEditRect(var ARect: TRect);
begin
...
procedure TDBGridSearchPanelTextEditEh.CancelSearchEditorMode;
begin
  SpecInternalSetText('');
...
procedure TDBGridSearchPanelTextEditEh.CancelFilter;
begin
  SpecInternalSetText('');
  TDBGridSearchPanelEhCrack(TCustomDBGridEhCrack(Grid).SearchPanel).InterSetSearchingText(Text);
//  TCustomDBGridEhCrack(Grid).SearchEditorMode := False;
...
procedure TDBGridSearchPanelTextEditEh.ApplySearchFilter;
begin
...
procedure TDBGridSearchPanelTextEditEh.UpdateModified;
begin
  if Assigned(OnUpdateModified) then
    OnUpdateModified(Self);
end;

function TDBGridSearchPanelTextEditEh.CalcAutoHeight: Integer;
var
  DC: HDC;
  SaveFont: HFont;
  I: Integer;
...
procedure TDBGridSearchPanelTextEditEh.CheckAddTextToList;
begin
  Items.Add(Text);
end;

procedure TDBGridSearchPanelTextEditEh.CMWantSpecialKey(var Message: TCMWantSpecialKey);
begin
  inherited;
...
procedure TDBGridSearchPanelTextEditEh.WndProc(var Message: TMessage);
var
...
function TDBGridSearchPanelTextEditEh.GetSearchPanelControl: TDBGridSearchPanelControlEh;
begin
  Result := TDBGridSearchPanelControlEh(Owner);
end;
...
constructor TDBGridSearchPanelControlEh.Create(AGrid: TCustomDBAxisGridEh);
begin
...
begin
  ...
  FFindEditor := TDBGridSearchPanelTextEditEh.Create(Self);
...
//  FFindEditor.EditButton.Style := ebsAltDropDownEh;
  ...
  begin
    ...
    FindBtn.Enabled := True; //Fixup VCL
