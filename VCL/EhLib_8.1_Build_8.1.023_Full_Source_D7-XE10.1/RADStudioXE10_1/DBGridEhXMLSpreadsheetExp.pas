      ...
      begin
        ...
        begin
          ...
          begin
            ...
            HeaNode := THeadTreeNode(TList(ListOfHeadTreeNodeList.Items[k]).Items[i]);
            if ColIndexNeeded
  ...
  begin
    ...
    begin
      ...
      CellType  := 'String';
            ...
            and (not Column.Field.IsNull) // check for minimum date
            and (Column.Field.AsDateTime < EncodeDate(1900, 1, 1)) // if date < 01-01-1900 then write as text
    then
    begin
      CellValue := FColCellParamsEh.Text;
      CellType  := 'String';
...
{$ENDIF}
        ...
        then
        begin
          if {(Column.DisplayFormat <> '') and} IsNumber(Column.DisplayFormat) then
            CellType := 'Number'
          else
            CellType := 'String';
        end
