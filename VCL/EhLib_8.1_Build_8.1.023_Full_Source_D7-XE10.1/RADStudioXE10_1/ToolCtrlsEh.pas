...
procedure DrawHighlightedSubTextEh(C: TCanvas;AR: TRect;X, Y: Integer; const T: string;
  ...
  const S: String;CI: Boolean;HC: TColor;Pos: Integer;PosC: TColor);
...
begin
  Result := WriteRotatedTextEh(ACanvas, ARect, FillRect,
    DX, DY, Text, Alignment, Layout, 90, EndEllipsis, CalcTextExtent);
end;
...
//  OldFontHandle := SelectObject(ACanvas.Handle, ACanvas.Font.Handle);
...
//    ACanvas.Font.Handle := OldFontHandle;
//    ACanvas.Font.Handle := 0;
//    SelectObject(ACanvas.Handle, OldFontHandle);
...
begin
  ...
  begin
    s := Text[i];
//    ACanvas.TextRect(CharRect, s, [tfCenter]);
...
procedure DrawClipped(imList: TCustomImageList; Bitmap: TBitmap;
  ACanvas: TCanvas; ARect: TRect; Index, ALeftMarg: Integer;
...
procedure DrawHighlightedSubTextEh(C: TCanvas; AR: TRect; X, Y: Integer;
  ...
  L, R: Integer; rlr: Boolean; const S: String; CI: Boolean; HC: TColor; Pos: Integer;
  PosC: TColor);
type
  lire = record
    Start: Longint;
...
//            ThemeServices.GetElementSize(Canvas.Handle, Details, esActual, Size);
...
procedure TEditButtonImagesEh.SetDisabledIndex(const Value: TImageIndex);
begin
...
procedure TEditButtonImagesEh.SetHotIndex(const Value: TImageIndex);
begin
...
procedure TEditButtonImagesEh.SetNormalIndex(const Value: TImageIndex);
begin
...
procedure TEditButtonImagesEh.SetPressedIndex(const Value: TImageIndex);
begin
