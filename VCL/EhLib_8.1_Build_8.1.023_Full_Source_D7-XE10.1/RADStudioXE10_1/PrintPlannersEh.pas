...
//procedure TPlannerControlPrintServiceEh.PrintPage;
//begin
//  inherited PrintPage;
//end;
...
//      Planner.TimeSpanParams.GetActualColor,
//      Planner.TimeSpanParams.GetActualAltColor);
  end;
end;
...
begin
  ...
  State := [];
  Grid.GetDrawCellParams(ACol, ARow, ARect, State, CellType, ALocalCol, ALocalRow, FDrawCellArgs);
  FDrawCellArgs.HorzMargin := Trunc(FDrawCellArgs.HorzMargin * ScaleX);
  FDrawCellArgs.VertMargin := Trunc(FDrawCellArgs.VertMargin * ScaleY);

  case CellType of
    pctTopLeftCellEh:
      PrintTopLeftCell(ACol, ARow, ARect, ALocalCol, ALocalRow, FDrawCellArgs);
    pctDataCellEh:
      PrintDataCell(ACol, ARow, ARect, ALocalCol, ALocalRow, FDrawCellArgs);
    pctAlldayDataCellEh:
      PrintAlldayDataCell(ACol, ARow, ARect, ALocalCol, ALocalRow, FDrawCellArgs);
    pctResourceCaptionCellEh:
      PrintResourceCaptionCell(ACol, ARow, ARect, ALocalCol, ALocalRow, FDrawCellArgs);
    pctInterResourceSpaceEh:
      PrintInterResourceCell(ACol, ARow, ARect, ALocalCol, ALocalRow, FDrawCellArgs);
    pctDayNameCellEh:
      PrintDayNamesCell(ACol, ARow, ARect, ALocalCol, ALocalRow, FDrawCellArgs);
    pctDateBarEh:
      PrintDateBar(ACol, ARow, ARect, ALocalCol, ALocalRow, FDrawCellArgs);
    pctDateCellEh:
      PrintDateCell(ACol, ARow, ARect, ALocalCol, ALocalRow, FDrawCellArgs);
    pctTimeCellEh:
      PrintTimeCell(ACol, ARow, ARect, ALocalCol, ALocalRow, FDrawCellArgs);
    pctWeekNoCell:
      PrintWeekNoCell(ACol, ARow, ARect, ALocalCol, ALocalRow, FDrawCellArgs);
  end;
end;
...
begin
  ...
  SprCell := Grid.SpreadArray[ACol, ARow];
