...
begin
  ...
  SelectClipRgn(FControl.Canvas.Handle, 0);
...
//  FControl.Canvas.Brush.Style := bsClear;
  if Color <> clDefault
    then FControl.Canvas.Brush.Color := Color
    else FControl.Canvas.Brush.Color := FControl.GetFillColor;
...
begin
  ...
  ShowWindow(mrc.Handle, SW_HIDE); //For Delphi 5 design time
...
//  inherited DropDown;
  ...
  begin
    ...
    TPopupMonthCalendarEh(DropDownCalendar).Font := Font;
