...
procedure TXMLSpreadsheetExportEh.InitializeStyle(var AStyle: TSpShStyleEh);
var
...
//  FXMLStream.WriteString(' ss:Width="' + VarToStr(ColumnWidth * 72 / 96) + '"');
...
begin
  ...
  // SpShStream.WriteString(' ss:DefaultRowHeight="15"');
