...
begin
  ...
  begin
    ...
    DrR := ClientRect;//Rect(Left, Top, Left + Width, Top + Height);
    ...
    begin
      ...
      begin
        ...
        Canvas.StretchDraw(DrR, Image.Picture.Graphic);
      end
      else
        Canvas.Draw(DrR.Left + (DrR.Right - DrR.Left - Image.Picture.Width) div 2,
          DrR.Top + (DrR.Bottom - DrR.Top - Image.Picture.Height) div 2,
          Image.Picture.Graphic);
    end else
    begin
      SNone := 'srNone';
      Canvas.TextOut(DrR.Left + (DrR.Right - DrR.Left - Canvas.TextWidth(SNone)) div 2,
