...
protected
     ...
     FPivotCaches: TXLSPivotCacheDefinitions;
...
public
     ...
     property PivotCaches: TXLSPivotCacheDefinitions read FPivotCaches;
...
begin
  ...
  FPivotCaches := TXLSPivotCacheDefinitions.Create;
...
procedure TXc12BookViews.Clear;
var
  Item: TXc12BookView;
begin
  inherited Clear;
