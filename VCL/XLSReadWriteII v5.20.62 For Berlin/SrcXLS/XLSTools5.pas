...
public
     ...
     procedure AssignText(const AText: AxUCString; AFont: TXc12Font); overload;
     procedure AssignText(const AText: AxUCString; AFirstFont: TXc12Font; AFontRuns: PXc12FontRunArray; AFontRunsCount: integer); overload;
...
procedure TXLSFormattedText.AssignText(const AText: AxUCString; AFirstFont: TXc12Font; AFontRuns: PXc12FontRunArray; AFontRunsCount: integer);
var
  i,j,k: integer;
  S: AxUCString;
  S2: AxUCString;
...
procedure TXLSFormattedText.AssignText(const AText: AxUCString; AFont: TXc12Font);
var
  Item: TXLSFormattedTextItem;
  S: AxUCString;
  S2: AxUCString;
