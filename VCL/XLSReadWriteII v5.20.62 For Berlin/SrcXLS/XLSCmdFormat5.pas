...
{$endif}
     ...
     Xc12DataSST5,
     XLSUtils5, XLSMMU5, XLSCellMMU5, XLSCellAreas5, XLSColumn5, XLSRow5;
...
begin
  if FSheet = Nil then
    raise Exception.Create('No worksheet defined fo Apply');
...
// +-------+
  if (Cols = 1) and (Rows = 1) then
    DoMergeCell(ACol1,ARow1,[cbsTop,cbsLeft,cbsRight,cbsBottom])
// +-------+-------+
// |   1   |   3   |
// +-------+-------+
  else if (Cols = 2) and (Rows = 1) then begin
    DoMergeCell(ACol1,ARow1,[cbsTop,cbsLeft,cbsInsideVert,cbsBottom]);
    DoMergeCell(ACol2,ARow1,[cbsTop,cbsRight,cbsBottom]);
  end
// +-------+-------+-------+
// |   1   |   2   |   3   |
// +-------+-------+-------+
    ...
    for C := ACol1 + 1 to ACol2 - 1 do
      DoMergeCell(C,ARow1,[cbsTop,cbsInsideVert,cbsBottom]);
    DoMergeCell(ACol2,ARow1,[cbsTop,cbsRight,cbsBottom]);
  end
// +-------+
// |   1   |
...
// +-------+
    ...
    DoMergeCell(ACol1,ARow1,[cbsTop,cbsLeft,cbsRight,cbsInsideHoriz]);
    DoMergeCell(ACol1,ARow2,[cbsLeft,cbsRight,cbsBottom]);
  end
// +-------+
// |   1   |
// +-------+
...
// +-------+
    ...
    for R := ARow1 + 1 to ARow2 - 1 do
      DoMergeCell(ACol1,R,[cbsLeft,cbsRight,cbsInsideHoriz]);
    DoMergeCell(ACol1,ARow2,[cbsLeft,cbsRight,cbsBottom]);
  end
// +-------+-------+
// |   1   |   3   |
...
// +-------+-------+
    ...
    DoMergeCell(ACol1,ARow1,[cbsTop,cbsLeft,cbsInsideHoriz,cbsInsideVert]);
    DoMergeCell(ACol1,ARow2,[cbsLeft,cbsBottom,cbsInsideVert]);
    DoMergeCell(ACol2,ARow1,[cbsTop,cbsRight,cbsInsideHoriz]);
    DoMergeCell(ACol2,ARow2,[cbsRight,cbsBottom]);
  end
// +-------+-------+-------+
// |   1   |   2   |   3   |
// +-------+-------+-------+
...
// +-------+-------+-------+
    ...
    for C := ACol1 + 1 to ACol2 - 1 do begin
      DoMergeCell(C,ARow1,[cbsTop,cbsInsideHoriz,cbsInsideVert]);
      DoMergeCell(C,ARow2,[cbsBottom,cbsInsideVert]);
    end;
    DoMergeCell(ACol2,ARow1,[cbsTop,cbsRight,cbsInsideHoriz]);
    DoMergeCell(ACol2,ARow2,[cbsRight,cbsBottom]);
  end
...
// +-------+-------+
    ...
    DoMergeCell(ACol1,ARow1,[cbsTop,cbsLeft,cbsInsideHoriz,cbsInsideVert]);
    for R := ARow1 + 1 to ARow2 - 1 do
      DoMergeCell(ACol1,R,[cbsLeft,cbsInsideVert,cbsInsideHoriz]);
    DoMergeCell(ACol1,ARow2,[cbsLeft,cbsBottom,cbsInsideVert]);
    DoMergeCell(ACol2,ARow1,[cbsTop,cbsRight,cbsInsideHoriz]);
    for R := ARow1 + 1 to ARow2 - 1 do
      DoMergeCell(ACol2,R,[cbsRight,cbsInsideHoriz]);
    DoMergeCell(ACol2,ARow2,[cbsRight,cbsBottom]);
  end
// +-------+-------+-------+
// |   1   |   2   |   3   |
...
// +-------+-------+-------+
    ...
    DoMergeCell(ACol1,ARow1,[cbsTop,cbsLeft,cbsInsideVert,cbsInsideHoriz]);
    for R := ARow1 + 1 to ARow2 - 1 do
      DoMergeCell(ACol1,R,[cbsLeft,cbsInsideVert,cbsInsideHoriz]);
    DoMergeCell(ACol1,ARow2,[cbsLeft,cbsBottom,cbsInsideVert]);

    for C := ACol1 + 1 to ACol2 - 1 do
      DoMergeCell(C,ARow1,[cbsTop,cbsInsideVert,cbsInsideHoriz]);
    for R := ARow1 + 1 to ARow2 - 1 do begin
      for C := ACol1 + 1 to ACol2 - 1 do
        DoMergeCell(C,R,[cbsInsideVert,cbsInsideHoriz]);
    end;
    for C := ACol1 + 1 to ACol2 - 1 do
      DoMergeCell(C,ARow2,[cbsBottom,cbsInsideVert]);
  ...
  for i := Low(TCmdFmtXFProp) to High(TCmdFmtXFProp) do begin
    if FAssigneds[i] then begin
      case i of
        ...
        cfxfJustifyDist  : ADest.Options := ADest.Options + [foJustifyLastLine];
        cfxfWrapText     : ADest.Options := ADest.Options + [foWrapText];
        cfxfShrinkToFit  : ADest.Options := ADest.Options + [foShrinkToFit];
        cfxfMergeCells   : ;
