...
public
     ...
     procedure Assign(ASource: TXLSMoveCopyItem); override;
...
procedure TXLSConditionalFormat.Assign(ASource: TXLSMoveCopyItem);
begin
  raise Exception.Create('Assign not implemented');
end;
