...
type  TXc12ImageType = (x12itJPEG,x12itPNG,x12itEMF,x12itWMF,x12itUnknown);
const Xc12ImageTypeStr: array[TXc12ImageType] of AxUCString = ('jpeg','png','emf','wmf','???');
...
begin
  case AType of
    ...
    x12itEMF    : Result := 'emf';
    x12itWMF    : Result := 'wmf';
    else          raise Exception.Create('Unknown image type');
  end;
end;
