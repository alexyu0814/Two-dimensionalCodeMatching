  ...
  try
    ...
    for i := 0 to FPtgsCount - 1 do begin
      ...
      case GetBasePtgs(Ptgs.Id) of
        ...
        xptgName      : Stack.PushIgnore; // raise Exception.Create('Name not excpected here');
        ...
        else raise Exception.CreateFmt('Unknown Ptg "%.2X"',[Ptgs.Id]);
      end;
    end;
  finally
    Stack.Free;
...
begin
  ...
  while PtgsSz > 0 do begin
    ...
    if L < 0 then
      raise Exception.CreateFmt('Unknown ptgs %.2X',[APtgs.Id]);
