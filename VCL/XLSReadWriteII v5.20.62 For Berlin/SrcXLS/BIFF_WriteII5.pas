...
//     procedure SetBorderDiagLines(const Value: TXc12DiagLines);
...
begin
  if (Color.ColorType = exctIndexed) and (Color.Tint = 0) then
    ...
    Result := RGBToClosestIndexColor(RGB);
  end;
end;
...
begin
  if FMulblankData.CachePtr > High(FMulblankData.Cache) then
    raise Exception.Create('Mulblank Cache overflow');
    ...
    case Xc12Sheet.Cells.IterCellType of
      ...
      xctError         : begin
        ...
        case Xc12Sheet.Cells.IterGetError of
          errUnknown: raise Exception.CreateFmt('Invalid error value in cell %d:%d',[RecBool.Row,RecBool.Col]);
        ...
        case Xc12Sheet.Cells.FormulaHelper.FormulaType of
          ...
          xcftArray         : begin
            ...
            if Ptgs.Id = xptg_EXCEL_97 then
              ...
              raise Exception.Create('TODO Array consts 97');
            end
            else begin
...
//      end;
      FBoundsheetList.AddSheet(i,FManager.Worksheets[i].Name,FXLS.Sheets[i].Hidden,FXLS.Sheets[i].WorksheetType);
    end;
  ...
  if AStr = Nil then begin
    ...
    case AStr.Options of
      ...
      STRID_FAREAST_RICH_UC: begin
        ...
        raise Exception.CreateFmt('STT: Unhandled string type in Write (%.2X) # %d',[AStr.Options,FCurrIndex]);
    end;
  end;
  Inc(FCurrIndex);
end;
